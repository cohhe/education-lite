<?php
/**
 * Custom template tags for Education 1.0
 *
 * @package WordPress
...
if ( ! function_exists( 'education_paging_nav' ) ) :
/**
...
if ( ! function_exists( 'education_post_nav' ) ) :
/**
 ...
 * @return void
 */
function education_posted_on( $post_id = '' ) {
	global $post;
...
function education_categorized_blog() {
	if ( false === ( $all_the_cool_cats = get_transient( 'education_category_count' ) ) ) {
		...
		set_transient( 'education_category_count', $all_the_cool_cats );
	}
...
function education_category_transient_flusher() {
	// Like, beat it. Dig?
	delete_transient( 'education_category_count' );
}
 ...
 * @return void
*/
function education_post_thumbnail() {
	...
	?>
	<?php
		the_post_thumbnail( 'education-huge-width' );
	?>
	...
	<?php
		the_post_thumbnail( 'education-full-width' );
	?>
	</a>

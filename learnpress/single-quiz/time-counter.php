    ...
    <div class="quiz-timer">
        ...
        <p class="quiz-countdown-text">
            <span class="quiz-time-remaining-text">
                <?php echo apply_filters( 'learn_press_quiz_time_remaining_text', __( 'Time remaining', 'education-lite' ) ); ?>
            </span>
            <span class="quiz-time-remaining-label"><?php echo apply_filters( 'learn_press_quiz_time_label', __( 'mins/secs', 'education-lite' ) ); ?></span>
        </p>
    </div>
</div>

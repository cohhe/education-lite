...
<div class="quiz-question-nav-buttons">
	...
	<button type="button" data-nav="prev" class="prev-question" data-url="<?php //echo $prev; ?>">
		<?php echo apply_filters( 'learn_press_quiz_question_nav_button_back_title', __( 'Back', 'education-lite' ) ); ?>
	</button>

	<button type="button" data-nav="next" class="next-question" data-url="<?php //echo $next; ?>">
		<?php echo apply_filters( 'learn_press_quiz_question_nav_button_next_title', __( 'Next', 'education-lite' ) ); ?>
	</button>

	<button class="button-finish-quiz btn hidden" quiz-id="<?php echo get_the_ID() ?>" data-area="nav">
		<?php echo apply_filters( 'learn_press_finish_quiz_text', __( "Finish", "education-lite" ) );?>
	</button>
